...
import (
	...
	http "github.com/jscastelblancoh/statistic_service/statistic/pkg/http"
...
var fs = flag.NewFlagSet("statistic", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "statistic")
